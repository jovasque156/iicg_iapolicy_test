...
mdlit("Las herramientas de IA son poderosas para mejorar el aprendizaje, la creatividad y la innovación. Pero **no son perfectas ni infalibles**. El mismo estudio mencionado arriba (@(📖)(descargar aquí)(https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4573321)) reveló que cuando se usan herramientas de IA para ciertas tareas donde tienen tan buen desempeño (identificadas técnicamente como _fuera de la frontera_), los consultores *pueden entregar trabajos de peores calidad de hasta ~25 puntos porcentuales comparados con sus pares sin usar distintas IA*, tal como lo revela la figura de más abajo.  Esto nos muestra que las herramientas de IA **no pueden reemplazar el criterio y la responsabilidad de cada persona**. Al contrario, se deben usar con sabiduría y ética, aprovechando sus ventajas y evitando sus riesgos.")
...
st.markdown("Por ello, en la carrera de Ingeniería en Información y Control de Gestión hemos elaborado esta política con **[7 directrices](#directrices)** que orientan el uso de las herramientas de IA de manera segura, transparente y dentro del marco de libertad de cátedra.")


st.markdown("Extendemos la invitación a seguir esta política y así integrar las herramientas de IA en la formación y nuestro quehacer diario de forma crítica, reflexiva y responsable. Confiamos de que esta política será un aporte para la comunidad de IICG.")
...
st.write("1. Cada persona puede usar las aplicaciones de IA para potenciar y complementar el aprendizaje y la investigación, sin reemplazar el trabajo y la autonomía de decisión.")
...
st.markdown("3. Quien use las distintas IA es _responsable de tener un [conocimiento básico](#FAQ) de estas_ antes de emplearlas en sus trabajos, proyectos, y evaluaciones.")
...
st.write("6. Quien use las diferentes heramientas de IA debe ser consciente de sus **[limitaciones y riesgos](#FAQ)**, tomando medidas para mitigarlos si es necesario.")
st.write("7. Cada persona debe respetar la privacidad y la seguridad de los datos que le entrega a la aplicaciones de IA usadas en sus trabajos y proyectos, y debe obtener el consentimiento de las personas propietarias de los datos si es necesario.")
...
with st.expander("# ¿Dónde puedo aprender sobre como usar las distintas IA?"):
    ...
    st.write("Las herramientas de IA están en constante evolución y cada día surgen nuevos avances. Por eso, te recomendamos que estés al día con las últimas novedades y tendencias")
...
with st.expander("# Quiero saber sobre los riesgos y limitaciones de las aplicaciones de IA, ¿Dónde puedo leer más al respecto?"):
